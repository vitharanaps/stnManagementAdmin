import {
  ...
  const ViewLine = () => {
    ...
    const lineId = location.pathname.split("/")[2];
                  ...
                  >
                    ...
                    >
                      ...
                      <Box sx={{ display: "flex", gap: 2 }}>
                        ...
                        >
                          <DialogTitle>{`Do You Want to Delete ${lineData?.lineName}?`}</DialogTitle>
                          <DialogContent>
                            <DialogContentText id="alert-dialog-slide-description">
                              This is alert For Delete, {lineData?.lineName} ,
